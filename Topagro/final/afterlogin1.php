                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Bajara</h3>
                                <p><a href="availableproduce.php?prod=Bajara" class="btn btn-primary" role="button" >Check Availability</a> 
                              </div>
                            </div>
                        </div>
                ...
                <div class="row">       
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Makka</h3>
                                <p><a href="availableproduce.php?prod=Makka" class="btn btn-primary" role="button">Check Availability</a> 
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 col-md-3">
                            <div class="thumbnail">
                              ...
                              <div class="caption">
                                <h3>Jawar</h3>
                                <p><a href="availableproduce.php?prod=Jawar" class="btn btn-primary" role="button">Check Availability</a> 
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-1 col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Matar</h3>
                            <p><a href="availableproduce.php?prod=Matar" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                     </div>
                ...
                <div style="width:1000px; margin:190px; background-color:white; margin-top:50px">
                    <div class="row">
                        ...
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>Brinjal</h3>
                            <p><a href="availableproduce.php?prod=Brinjal" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                        </div> 
                ...
                <div class="row">       
                    ...
                    <div class="col-sm-1 col-md-3">
                        <div class="thumbnail">
                          ...
                          <div class="caption">
                            <h3>White Carrot</h3>
                            <p><a href="availableproduce.php?prod=White Carrot" class="btn btn-primary" role="button">Check Availability</a> 
                          </div>
                        </div>
                     </div>
